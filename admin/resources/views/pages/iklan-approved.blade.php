...
<div id="page-title">
    <h2>List Iklan Sudah Approval</h2>
    ...
    <div class="panel-body" id="box-panel">
        ...
        <div class="example-box-wrapper">
            <ul class="nav-responsive nav nav-tabs">                
                <li><a href="{{ url('/iklan') }}">Need Approved</a></li>
                <li class="active"><a href="#tab2" data-toggle="tab">Approved</a></li>
