...
<div id="page-title">
    ...
    <p>Halaman ini untuk melihat semua iklan.</p>
    @csrf
</div>
    ...
    <div class="panel-body" id="box-panel">
        ...
        <div class="example-box-wrapper">
            <ul class="nav-responsive nav nav-tabs">                
                <li>
                    <a href="{{ url('/iklan') }}">Need Approval</a>
                </li>
                <li><a href="{{ url('/iklan/approved') }}">Approved</a></li>
                <li  class="active" data-toggle="tab"><a href="#tab2">All</a></li>
                <li><a href="{{ url('/iklan/reject') }}">Reject</a></li>
            </ul>
    ...
    function showpdf(val) {                
     ...
     $(document).ready(function() {        
        var table = $('#datatable-tabletools').DataTable({
            ...
            processing      : true,
            serverSide      : true,
            ajax            : '{{ URL::asset('iklan/iklan_all') }}',
            columns         : [
                { data: 'id', name: 'id' },
